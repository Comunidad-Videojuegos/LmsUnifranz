<div class="w-full p-4 flex justify-around">
    ...
    <div class="flex-1 flex flex-col justify-around">
        ...
        <div>
            <h3 class="py-4">Carrera:</h3>
            <select id="optionsCareer" style="width: 300px; padding: 10px" class="rounded-lg text-black"></select>
        </div>
    </div>
</div>
...
<script>
    async function CreateStudent()
    {
        ...
        const careerId = document.getElementById("optionsCareer").value;

        await axiosInstance.post(`/admin-general/student`, {
            firstName, email, ci, dadLastName, momLastName, age, careerId
        });
    }
</script>
